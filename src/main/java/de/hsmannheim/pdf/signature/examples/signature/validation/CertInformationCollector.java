...
import de.hsmannheim.pdf.signature.examples.signature.cert.CertificateVerifier;
...
public class CertInformationCollector {
     ...
     */
    public CertSignatureInformation getCertInfo(byte[] signatureContent)
            throws CertificateProccessingException, IOException {
        ...
        try {
            ...
            System.err.println("Error occurred getting Certificate Information from Signature " + e.getMessage());
    ...
    private void getAlternativeIssuerCertificate(CertSignatureInformation certInfo, int maxDepth)
        ...
        try {
            ...
            System.err.println("Error getting alternative issuer certificate from " + certInfo.issuerUrl + " " + e.getMessage());
        }
    }
    ...
    private X509Certificate getCertFromHolder(X509CertificateHolder certificateHolder)
        ...
        try {
            ...
            System.err.println("Certificate Exception getting Certificate from certHolder. " + e.getMessage());
            throw new CertificateProccessingException(e);
        }
    }
     ...
     * @throws CertificateProccessingException
     */
    public CertSignatureInformation getCertInfo(X509Certificate certificate) throws CertificateProccessingException {
        try {
