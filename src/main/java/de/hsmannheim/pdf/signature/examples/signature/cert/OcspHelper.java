 ...
 */
package de.hsmannheim.pdf.signature.examples.signature.cert;
...
public class OcspHelper {
    ...
    private byte[] getKeyHashFromCertHolder(X509CertificateHolder certHolder) throws IOException {
        ...
        try {
            ...
            // should not happen
            System.err.println("SHA-1 Algorithm not found " + ex.getMessage());
            return new byte[0];
        }
    }
