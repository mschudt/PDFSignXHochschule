...
public abstract class CreateSignatureBase implements SignatureInterface {
    ...
    public byte[] sign(InputStream content) throws IOException {
        ...
        try {
            ...
            ESSCertID certid = new ESSCertID(userCertHash);
            SigningCertificate sigcert = new SigningCertificate(certid);

            final DERSet attrValues = new DERSet(sigcert);
            Attribute attr = new Attribute(PKCSObjectIdentifiers.id_aa_signingCertificate, attrValues);
            ...
            SignerInfoGenerator signerInfoGenerator = jcaSignerInfoGeneratorBuilder.build(sha1Signer, cert);
